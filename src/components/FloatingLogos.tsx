...
const logos = [
  ...
  { src: logoOpasuite, alt: "Opa Suite", size: 70, top: "50%", left: "68%", delay: 2, duration: 13, imgScale: 0.8 },
  { src: logoOlli, alt: "Olli", size: 66, top: "68%", left: "25%", delay: 1.5, duration: 15, imgScale: 0.8 },
];
