...
const logos = [
  ...
  { src: logoIxc, alt: "IXC", size: 76, top: "8%", left: "58%", delay: 1.2, duration: 14, imgScale: 1.05, offsetX: "0%", offsetY: "0%", bg: "transparent" },
  ...
  { src: logoInmap, alt: "InMap", size: 68, top: "5%", left: "12%", delay: 0.8, duration: 13, imgScale: 1.05, offsetX: "0%", offsetY: "0%", bg: "transparent" },
