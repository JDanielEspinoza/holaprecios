...
const logos = [
  { src: logoWispro, alt: "Wispro", size: 82, top: "12%", left: "30%", delay: 0, duration: 12, imgScale: 2.8 },
  { src: logoIxc, alt: "IXC", size: 76, top: "8%", left: "58%", delay: 1.2, duration: 14, imgScale: 2.5 },
  { src: logoHola, alt: "Hola Suite", size: 80, top: "38%", left: "18%", delay: 0.5, duration: 11, imgScale: 2.8 },
